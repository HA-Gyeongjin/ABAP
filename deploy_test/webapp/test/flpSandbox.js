		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 앱을 SAP로 업로드 테스트",
									"targetURL": "#synce25deploytest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce25deploytest-display": {
								"semanticObject": "synce25deploytest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e25.deploytest",
									"url": sap.ui.require.toUrl("sync/e25/deploytest")
								}
							}
						}
					}
