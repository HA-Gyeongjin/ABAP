		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "구독판매를 위한 App",
									"targetURL": "#synczecsales2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synczecsales2-display": {
								"semanticObject": "synczecsales2",
								"action": "display",
								"description": "구독판매를 위한 App",
								"title": "구독판매를 위한 App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.zec.sales2",
									"url": sap.ui.require.toUrl("sync/zec/sales2")
								}
							}
						}
					}
